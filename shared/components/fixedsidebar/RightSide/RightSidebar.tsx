...
import { Hash, Search, StarIcon } from "lucide-react";
...
//   return (
//     <div className={`w-72 container overflow-auto bg-gradient-to-b from-white to-amber-50 border-l border-amber-100 shadow-[0_0_15px_rgba(212,175,55,0.07)] p-5 h-auto ${className}`}>
//       {/* AI Assistant Section */}
//       <div className="mb-6">
//         <h3 className="text-sm uppercase text-gray-500 font-semibold tracking-wider mb-3">
//           AI Assistant
