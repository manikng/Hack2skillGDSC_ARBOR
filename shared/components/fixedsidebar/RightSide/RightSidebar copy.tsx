  ...
  return (
    <SidebarProvider>
      <Sidebar 
        ...
        className={className}
      >
        <SidebarContent className="bg-gradient-to-b from-white to-amber-50 border-l border-amber-100 shadow-[0_0_15px_rgba(212,175,55,0.07)] p-5">
